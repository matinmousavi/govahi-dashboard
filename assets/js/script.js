(function ($) {
  ...
  if ($.fn.scrollUp) {
    $.scrollUp({
      ...
      // svg append in scrool up

      scrollText: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 scrool">
